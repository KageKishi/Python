...
class Player:
    def __init__(self, x, y, w, h):
        ...
        self.idle_frames = []
        self.animations = {
            "idle" : [pygame.transform.smoothscale(pygame.image.load(f"assets/idle/idle{i}.png").convert_alpha(), (w, h)) for i in range(1, 7)],
            "run" : [pygame.transform.smoothscale(pygame.image.load(f"assets/walk/run{i}.png").convert_alpha(), (w, h)) for i in range(1, 9)]
        }
        self.state = "idle"
        self.frame_index = 0
        self.ani_speed = 0
...
background = pygame.transform.smoothscale(pygame.image.load("assets/background.jpg").convert(), (800, 600))
